...
{
    public class Ember : StoryboardObjectGenerator
    {
        [Configurable]
        public string Path = "";
        ...
        [Configurable]
        public float SpriteAngleRotation = 60;
        ...
        public override void Generate()
        {
            ...
            for (var i = 0; i < ParticleCount; i++)
            {
                ...
                var spriteRotation = moveAngle + MathHelper.DegreesToRadians(Random(-SpriteAngleRotation, SpriteAngleRotation));
